"use strict";exports.id=3349,exports.ids=[3349],exports.modules={63349:(e,t,i)=>{i.r(t),i.d(t,{W3mApproveTransactionView:()=>h,W3mRegisterAccountNameSuccess:()=>V,W3mRegisterAccountNameView:()=>Z,W3mUpgradeWalletView:()=>S});var r=i(50861),o=i(52827),n=i(63044),a=i(26728),s=i(6611),l=i(60778),d=i(83344),c=i(22490);let u=(0,r.AH)`
  div {
    width: 100%;
  }
...
`;var w=function(e,t,i,r){var o,n=arguments.length,a=n<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(n<3?o(a):n>3?o(t,i,a):o(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};let x={sm:"md-regular",md:"lg-regular",lg:"lg-regular"},v={success:"sealCheck",error:"warning",warning:"exclamationCircle"},$=class extends r.WF{constructor(){super(...arguments),this.type="success",this.size="md",this.imageSrc=void 0,this.disabled=!1,this.href="",this.text=void 0}render(){return(0,r.qy)`
    ...
    `}imageTemplate(){return this.imageSrc?(0,r.qy)`<wui-image src=${this.imageSrc} size="inherit"></wui-image>`:(0,r.qy)`<wui-icon
      ...
      size="inherit"
      class="image-icon"
    ></wui-icon>`}};$.styles=[g.W5,g.fD,y],w([(0,o.MZ)()],$.prototype,"type",void 0),w([(0,o.MZ)()],$.prototype,"size",void 0),w([(0,o.MZ)()],$.prototype,"imageSrc",void 0),w([(0,o.MZ)({type:Boolean})],$.prototype,"disabled",void 0),w([(0,o.MZ)()],$.prototype,"href",void 0),w([(0,o.MZ)()],$.prototype,"text",void 0),$=w([(0,f.E)("wui-semantic-chip")],$),i(41298);let S=class extends r.WF{render(){return(0,r.qy)`
...
`;var F=function(e,t,i,r){var o,n=arguments.length,a=n<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(n<3?o(a):n>3?o(t,i,a):o(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};let Z=class extends r.WF{constructor(){super(),this.formRef=(0,k._)(),this.usubscribe=[],this.name="",this.error="",this.loading=E.f.state.loading,this.suggestions=E.f.state.suggestions,this.profileName=A.W.getAccountData()?.profileName,this.onDebouncedNameInputChange=T.w.debounce(e=>{e.length<4?this.error="Name must be at least 4 characters long":q.y.isValidReownName(e)?(this.error="",E.f.getSuggestions(e)):this.error="The value is not a valid username"}),this.usubscribe.push(E.f.subscribe(e=>{this.suggestions=e.suggestions,this.loading=e.loading}),A.W.subscribeChainProp("accountState",e=>{this.profileName=e?.profileName,e?.profileName&&(this.error="You already own a name")}))}firstUpdated(){this.formRef.value?.addEventListener("keydown",this.onEnterKey.bind(this))}disconnectedCallback(){super.disconnectedCallback(),this.usubscribe.forEach(e=>e()),this.formRef.value?.removeEventListener("keydown",this.onEnterKey.bind(this))}render(){return(0,r.qy)`
      <wui-flex
        ...
        .padding=${["1","3","4","3"]}
      >
        <form ${(0,k.K)(this.formRef)} @submit=${this.onSubmitName.bind(this)}>
          <wui-ens-input
    ...
    </wui-flex>`}isAllowedToSubmit(e){let t=e.split(".")?.[0],i=this.suggestions.find(e=>e.name?.split(".")?.[0]===t&&e.registered);return!this.loading&&!this.error&&!this.profileName&&t&&E.f.validateName(t)&&!i}async onSubmitName(e){try{if(!this.isAllowedToSubmit(e))return;C.E.sendEvent({type:"track",event:"REGISTER_NAME_INITIATED",properties:{isSmartAccount:(0,N.lj)(A.W.state.activeChain)===_.Vl.ACCOUNT_TYPES.SMART_ACCOUNT,ensName:e}}),await E.f.registerName(e),C.E.sendEvent({type:"track",event:"REGISTER_NAME_SUCCESS",properties:{isSmartAccount:(0,N.lj)(A.W.state.activeChain)===_.Vl.ACCOUNT_TYPES.SMART_ACCOUNT,ensName:e}})}catch(t){O.P.showError(t.message),C.E.sendEvent({type:"track",event:"REGISTER_NAME_ERROR",properties:{isSmartAccount:(0,N.lj)(A.W.state.activeChain)===_.Vl.ACCOUNT_TYPES.SMART_ACCOUNT,ensName:e,error:T.w.parseError(t)}})}}onEnterKey(e){if("Enter"===e.key&&this.name&&this.isAllowedToSubmit(this.name)){let e=`${this.name}${R.o.WC_NAME_SUFFIX}`;this.onSubmitName(e)}}};Z.styles=U,F([(0,o.MZ)()],Z.prototype,"errorMessage",void 0),F([(0,o.wk)()],Z.prototype,"name",void 0),F([(0,o.wk)()],Z.prototype,"error",void 0),F([(0,o.wk)()],Z.prototype,"loading",void 0),F([(0,o.wk)()],Z.prototype,"suggestions",void 0),F([(0,o.wk)()],Z.prototype,"profileName",void 0),Z=F([(0,c.EM)("w3m-register-account-name-view")],Z);var B=i(49695),H=i(71136);i(4977),i(17388),i(73019);let K=(0,r.AH)`
...
`,V=class extends r.WF{render(){return(0,r.qy)`
      ...
      >
        ...
        <wui-link
          @click=${()=>{T.w.openHref(B.T.URLS.FAQ,"_blank")}}
        >
          Learn more
