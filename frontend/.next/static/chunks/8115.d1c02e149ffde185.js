"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[8115],{18115:(e,t,i)=>{i.r(t),i.d(t,{W3mApproveTransactionView:()=>h,W3mRegisterAccountNameSuccess:()=>V,W3mRegisterAccountNameView:()=>Z,W3mUpgradeWalletView:()=>k});var r=i(28312),o=i(745),n=i(22492),a=i(33806),s=i(32549),l=i(54252),d=i(7478),c=i(52515);let u=(0,r.AH)`
  div {
    width: 100%;
  }
...
`;var z=function(e,t,i,r){var o,n=arguments.length,a=n<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(n<3?o(a):n>3?o(t,i,a):o(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};let I=class extends r.WF{constructor(){super(...arguments),this.name="",this.registered=!1,this.loading=!1,this.disabled=!1}render(){return(0,r.qy)`
      <button ?disabled=${this.disabled}>
        <wui-text class="name" color="primary" variant="md-regular">${this.name}</wui-text>
        ${this.templateRightContent()}
      </button>
    `}templateRightContent(){return this.loading?(0,r.qy)`<wui-loading-spinner size="lg" color="primary"></wui-loading-spinner>`:this.registered?(0,r.qy)`<wui-tag variant="info" size="sm">Registered</wui-tag>`:(0,r.qy)`<wui-tag variant="success" size="sm">Available</wui-tag>`}};I.styles=[g.W5,g.fD,M],z([(0,o.MZ)()],I.prototype,"name",void 0),z([(0,o.MZ)({type:Boolean})],I.prototype,"registered",void 0),z([(0,o.MZ)({type:Boolean})],I.prototype,"loading",void 0),z([(0,o.MZ)({type:Boolean})],I.prototype,"disabled",void 0),I=z([(0,f.E)("wui-account-name-suggestion-item")],I);var W=i(51882);i(39151);let D=(0,b.AH)`
  :host {
    position: relative;
    width: 100%;
...
`;var P=function(e,t,i,r){var o,n=arguments.length,a=n<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(n<3?o(a):n>3?o(t,i,a):o(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};let _=class extends r.WF{constructor(){super(...arguments),this.disabled=!1,this.loading=!1}render(){return(0,r.qy)`
      <wui-input-text
      ...
      ></wui-input-text>
    `}};_.styles=[g.W5,D],P([(0,o.MZ)()],_.prototype,"errorMessage",void 0),P([(0,o.MZ)({type:Boolean})],_.prototype,"disabled",void 0),P([(0,o.MZ)()],_.prototype,"value",void 0),P([(0,o.MZ)({type:Boolean})],_.prototype,"loading",void 0),P([(0,o.MZ)({attribute:!1})],_.prototype,"onKeyDown",void 0),_=P([(0,f.E)("wui-ens-input")],_),i(21330),i(76197),i(72873);var j=i(45312),q=i(87752);let U=(0,c.AH)`
  wui-flex {
    width: 100%;
  }
...
`;var F=function(e,t,i,r){var o,n=arguments.length,a=n<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(n<3?o(a):n>3?o(t,i,a):o(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};let Z=class extends r.WF{constructor(){super(),this.formRef=(0,S._)(),this.usubscribe=[],this.name="",this.error="",this.loading=E.f.state.loading,this.suggestions=E.f.state.suggestions,this.profileName=A.W.getAccountData()?.profileName,this.onDebouncedNameInputChange=C.w.debounce(e=>{e.length<4?this.error="Name must be at least 4 characters long":q.y.isValidReownName(e)?(this.error="",E.f.getSuggestions(e)):this.error="The value is not a valid username"}),this.usubscribe.push(E.f.subscribe(e=>{this.suggestions=e.suggestions,this.loading=e.loading}),A.W.subscribeChainProp("accountState",e=>{this.profileName=e?.profileName,e?.profileName&&(this.error="You already own a name")}))}firstUpdated(){this.formRef.value?.addEventListener("keydown",this.onEnterKey.bind(this))}disconnectedCallback(){super.disconnectedCallback(),this.usubscribe.forEach(e=>e()),this.formRef.value?.removeEventListener("keydown",this.onEnterKey.bind(this))}render(){return(0,r.qy)`
      <wui-flex
    ...
    </wui-flex>`}isAllowedToSubmit(e){let t=e.split(".")?.[0],i=this.suggestions.find(e=>e.name?.split(".")?.[0]===t&&e.registered);return!this.loading&&!this.error&&!this.profileName&&t&&E.f.validateName(t)&&!i}async onSubmitName(e){try{if(!this.isAllowedToSubmit(e))return;N.E.sendEvent({type:"track",event:"REGISTER_NAME_INITIATED",properties:{isSmartAccount:(0,T.lj)(A.W.state.activeChain)===j.Vl.ACCOUNT_TYPES.SMART_ACCOUNT,ensName:e}}),await E.f.registerName(e),N.E.sendEvent({type:"track",event:"REGISTER_NAME_SUCCESS",properties:{isSmartAccount:(0,T.lj)(A.W.state.activeChain)===j.Vl.ACCOUNT_TYPES.SMART_ACCOUNT,ensName:e}})}catch(t){O.P.showError(t.message),N.E.sendEvent({type:"track",event:"REGISTER_NAME_ERROR",properties:{isSmartAccount:(0,T.lj)(A.W.state.activeChain)===j.Vl.ACCOUNT_TYPES.SMART_ACCOUNT,ensName:e,error:C.w.parseError(t)}})}}onEnterKey(e){if("Enter"===e.key&&this.name&&this.isAllowedToSubmit(this.name)){let e=`${this.name}${R.o.WC_NAME_SUFFIX}`;this.onSubmitName(e)}}};Z.styles=U,F([(0,o.MZ)()],Z.prototype,"errorMessage",void 0),F([(0,o.wk)()],Z.prototype,"name",void 0),F([(0,o.wk)()],Z.prototype,"error",void 0),F([(0,o.wk)()],Z.prototype,"loading",void 0),F([(0,o.wk)()],Z.prototype,"suggestions",void 0),F([(0,o.wk)()],Z.prototype,"profileName",void 0),Z=F([(0,c.EM)("w3m-register-account-name-view")],Z);var B=i(7273),H=i(19628);i(54279),i(36698),i(82786);let K=(0,r.AH)`
  .continue-button-container {
    width: 100%;
  }
`,V=class extends r.WF{render(){return(0,r.qy)`
      <wui-flex
        flexDirection="column"
        alignItems="center"
        gap="6"
      ...
      >
        ...
        <wui-link
          @click=${()=>{C.w.openHref(B.T.URLS.FAQ,"_blank")}}
        >
          Learn more
    ...
    </wui-flex>`}redirectToAccount(){H.I.replace("Account")}};V.styles=K,V=function(e,t,i,r){var o,n=arguments.length,a=n<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(n<3?o(a):n>3?o(t,i,a):o(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a}([(0,c.EM)("w3m-register-account-name-success-view")],V)}}]);